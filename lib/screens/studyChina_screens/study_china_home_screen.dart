...
class _StudyChinaHomeScreenState extends State<StudyChinaHomeScreen> {
  List<String> listTitle = ["БНХАУ сурах", "Их дээд сургуулийн мэдээлэл", "Тэтгэлэг"];
  int selectedIndex = 0;
  @override
        ...
        children: [
          ...
          SingleChildScrollView(
            ...
            child: Container(
              ...
              child: Row(
                children: [for (int index = 0; index < 3; index++) _tab(listTitle[index], index)],
              ),
            ),
          ),
          Expanded(child: studyInChinaGrid(listTitle[selectedIndex], (selectedIndex + 1) * 3))
        ],
      ),
    );
  }
  ...
  Widget studyInChinaV1() {
    return SingleChildScrollView(
      child: Column(
        children: [for (int index = 0; index < 3; index++) studyInChinaTile(listTitle[index])],
      ),
    );
  }
  ...
  studyInChinaGrid(String title, int itemLength) {
    var listBanner = [
      "https://i.pinimg.com/736x/db/ac/32/dbac32146104c67946de2a6d857a57c0.jpg",
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU7adimEWjO8NMlVfBl4_Cez1BlKr2Z51gTTqK_Spicbw4eqnQl0ltiMOiwWfVi4o7I3k&usqp=CAU",
      "https://i.pinimg.com/736x/bf/06/3a/bf063a19d01d5fbdf38a8fd72c723815.jpg",
    ...
    var listTitle = [
      "Яагаад заавал БНХАУ гэж? Оюутны боловсрол боловср",
      "БНХАУ -н боловсрол",
      "Гадаад оюутны амьдрал",
    ];
